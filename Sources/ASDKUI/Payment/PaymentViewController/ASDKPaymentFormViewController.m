...
- (void)viewDidLoad
{
    ...
    self.title = [ASDKUI_Texts current].acq_screen_title;
...
- (void)setSelectedCard:(ASDKCard *)selectedCard
{
    ...
    if (_selectedCard)
    {
        ...
        [self externalCardsCell].titleLabel.text = [ASDKUI_Texts current].acq_saved_card_label;
    ...
    else
    {
        ...
        [self externalCardsCell].titleLabel.text = [ASDKUI_Texts current].acq_new_card_label;
...
- (ASDKEmailCell *)emailCell
{
    if (!_emailCell)
    {
		...
		[_emailCell.emailTextField setPlaceholder:[ASDKUI_Texts current].acq_email_hint];
