...
- (void)viewDidLoad
{
    ...
    self.title = [ASDKUI_Texts current].acq_title_card_list;
    
    [self.tableView setBackgroundColor:[ASDKDesign colorTableViewBackground]];
    
    ASDKBarButtonItem *cancelButton =
    [[ASDKBarButtonItem alloc]
...
- (ASDKAddNewCardCell *)addNewCardCell
{
    if (!_addNewCardCell)
    {
        ...
        _addNewCardCell.addCardTitleLabel.text = [ASDKUI_Texts current].acq_enter_new_card_label;
    }
